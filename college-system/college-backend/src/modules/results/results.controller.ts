...
export const getStudentReportCard = async (req: Request, res: Response) => {
  try {
    ...
    const result = await service.getStudentReportCard(studentId, academicYear)
...
export const getSectionResults = async (req: Request, res: Response) => {
  try {
    ...
    const result = await service.getSectionResults(sectionId, subjectId, examId)
...
export const getTopStudents = async (req: Request, res: Response) => {
  try {
    ...
    const result = await service.getTopStudents(sectionId, limit)
