...
const NAV_ITEMS: Record<UserRole, NavItem[]> = {
  SUPER_ADMIN: [
    ...
    { label: "Live View", href: "/principal/live-view", icon: MonitorPlay },
    { label: "Students", href: "/principal/students", icon: Users },
    { label: "Staff", href: "/principal/staff", icon: UserCog },
    { label: "Boys Campus", href: "/principal/campus/boys", icon: Building2 },
    { label: "Girls Campus", href: "/principal/campus/girls", icon: Building2 },
