  ...
  (
        ...
        <div className={cn("group flex items-center gap-2.5", className)}>
          ...
          {value && showWhatsApp && isMobile && (
            ...
            >
              ...
              <span className="font-body text-[var(--font-size-sm)] font-medium text-[#25D366]">WhatsApp</span>
            </button>
          )}
          ...
          {value && showCopy && (
            <div className="relative flex items-center">
              ...
              {copied && (
                <span className="absolute -top-7 left-1/2 -translate-x-1/2 rounded bg-[var(--text)] px-2 py-1 text-[var(--font-size-xs)] whitespace-nowrap font-medium text-[var(--bg)] shadow-sm">
                  Copied!
                </span>
              )}
            </div>
    ...
    return (
      <div className={cn("flex w-full flex-col gap-1.5", className)}>
        ...
        >
          {/* Left Pill */}
          <div className="flex select-none items-center justify-center gap-1.5 rounded-l-[var(--radius-md)] border-r border-[var(--border)] bg-[var(--surface-hover)] px-3 text-[var(--font-size-base)] text-[var(--text-secondary)]">
            <span>🇵🇰</span>
            <span>+92</span>
          </div>
